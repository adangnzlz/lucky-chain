...
async function main() {
  ...
  console.log("Mock VRFCoordinator deployed to local network at:", vrfCoordinatorMock.address);
  ...
  console.log("LinkToken deployed to local network at:", linkToken.address);
